...
...
creating a science around measuring and observing language models is a wholistic process. I think that is the main takeaway here. we must gather data at training time as well as inference time. and a scientific method would be generalizable across more dimensions.
but how do we create a golden telephone when others have always failed? why is it that when we approach meaning and the conveyance of it on a meta level the same scientific method starts to become muddier?
